---
slug: voc-vach-code-thu-1-con-crawler-blockchain-phan-1
title: Vọc vạch code thử 1 crawler event trên mạng blockchain phần 1
date: 04/04/2023
image: blockchain-crawler/bg.webp
author: { name: Đức Huy Hoàng, avatar: avatar.jpg }
description: "Bài viết hướng dẫn chi tiết về 1 chương trình ví dụ crawler event của blockchain"
